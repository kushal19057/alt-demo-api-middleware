...
@alt_backend_api.get("/api/v1/get")
async def get_data():
    # data = sheet.get_all_records()
    # print(data)
    return {'response': {"data": "none"}, 'message':  'retrieved data'}

@alt_backend_api.get("/api/v1/get/{id}")
async def get_data_by_id(id: int):
    ...
    return {'response': {"id": id}, 'message':  'success'}
...
@alt_backend_api.post("/api/v1/post/")
